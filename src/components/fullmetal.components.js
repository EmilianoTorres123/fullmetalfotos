...
export default class Fullmetal extends Component {
  ...
  updatePublished(status) {
    FullmetalDataService.update(this.state.currentTutorial.id, {
      published: status,
    })
      .then(() => {
        this.setState((prevState) => ({
  ...
  updateTutorial() {
    ...
    FullmetalDataService.update(this.state.currentTutorial.id, data)
      .then(() => {
        this.setState({
  ...
  deleteTutorial() {
    FullmetalDataService.delete(this.state.currentTutorial.id)
      .then(() => {
